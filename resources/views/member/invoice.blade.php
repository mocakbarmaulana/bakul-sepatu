        ...
        <div class="container">
            ...
            <div class="invoice-container">
                ...
                <div class="button-box">
                    <div class="container">
                        @if ($order->status == 0)
                        <button class="btn btn-primary" data-bs-target="#modalFormPayment"
                            data-bs-toggle="modal">Confirm
                            payment
                        </button>
                        @endif
                        {{-- <button class="btn btn-success">Pesanan diterima</button> --}}
                        <a href="{{route('member.order')}}" class="btn btn-info">&#8592; Kembali</a>
                    </div>
                </div>
            </div>

            {{-- Modal Confirm Payment --}}
            <div class="modal fade" id="modalFormPayment" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="total" class="form-control"
                                                value="{{old('total')}}" placeholder="IDR.1200000">
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="submitConfirmPayment()">Konfimasi
                                Bukti
                                Pembayaran</button>
                        </div>
                    </div>
